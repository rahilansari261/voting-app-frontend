...
export default function DashboardPage() {
  ...
  const isNetworkError = error?.message?.includes("Network Error") || error?.code === "ERR_NETWORK" || error?.response?.status >= 500;
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-600 mb-4">Unable to connect to the server. Please check your internet connection or try again later.</p>
          <div className="space-x-2">
          ...
          <div>
            ...
            <div className="space-y-4">
              {recentPolls.length > 0 ? (
                recentPolls.map((poll: Poll) => <PollCard key={poll.id} poll={poll} />)
              ) : (
                <Card>
          ...
          <div>
            ...
            <div className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">Your polls that are live and accepting votes</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">Your polls that are not yet published</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">All polls that are live across the platform</p>
                </CardContent>
              </Card>
            </div>
          </div>
